...
image::../images/Logica/Interfaces/IHotelManager.png[IHotelManager, width=600]
...
image::../images/Logica/Interfaces/IProductoManager.png[IProductoManager, width=600]
...
image::../images/Logica/Interfaces/IEmpleadoManager.png[IEmpleadoManager, width=600]
...
image::../images/Logica/Interfaces/IAuditorFacade.png[IAuditorFacade, width=600]

*consultarRegistroOperaciones(hotelID: int) : RegistroOperacion* +
``pre:`` +
Existe un hotel cuyo Hotel.hotelID es igual a hotelID +
``pos:`` +
Devuelve el RegistroOperacion del hotel desde su creación, recuperando el Hotel junto con todas las Reservaciones y estancias activas e historicas del hotel.

*consultarRegistroOperacionesCadena(fechaInicio: Date, fechaFin: Date) : RegistroOperacion* +
``pre:`` +
Existe hoteles en la cadena que estuvieron activos entre fechaInicio y fechaFin +
``pos:`` +
Devuelve un RegistroOperacion entre fechaInicio y fechaFin para todos los hoteles de la cadena, recuperando el Hotel junto con todas las Reservaciones y estancias activas e historicas del hotel.
...
image::../images/Logica/Interfaces/IEstanciaManager.png[IEstanciaManager, width=600]
