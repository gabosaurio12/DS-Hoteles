...
* agregarHotel(Hotel hotel)
* editarHotel(Hotel hotel)
* eliminarHotel(int hotelID)
...
* getServicios()
* getServicio(string nombreServicio)
* agregarServicio(Servicio servicio)
* editarServicio(Servicio servicio)
* eliminarServicio(int servicioID)
...
* solicitarRervacion(Reservacion reservacion)
* editarResrvacion(Resrvacion resrvacion)
* cancelarReservacion(Reservacion resrvacion)
* getReservaciones(Huesped huesped)
* getReservacionesHotel()
...
* getHuespedes()
* getHuesped(string nombreHuesped)
* registrarHuesped(Huesped huesped)
* editarHuesped(Huesped huesped)
* eliminarHuesped(int huespedID)
