...
El *SistemaHotel* tiene como propósito que el _Administrador de Hotel_ pueda gestionar la información de un hotel, así como las habitaciones (incluyendo su estado, si está reservada, ocupada o libre), servicios y productos. Aparte del _Administrador de Hotel_, el _Auditor_ podrá usar ciertas funciones del *SistemaHotel* con permisos limitados para poder llevar a cabo sus funciones.
