...
*Interfaces:* IHabitacionManager, IServicioManager, IProductoManager, IEmpleadoManager, HuespedFacade.
...
*Dependencias:* Depende del *SistemaHotel* (_HuespedFacade_) y la *PasarelaPagos* (_PagosFacade_).
...
*Dependencias:* Depende del *SistemaHotel* (_HuespedFacade_), la *PasarelaPagos* (_PagosFacade_) y *SistemaReservacion* (_IReservacionManager_).
