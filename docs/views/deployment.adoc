...
* *React* como motor del front-end
...
image:../images/Despliegue/manifestation/components/Manifest SistemaCadenaHotel.png[align=center, width=600]
...
image:../images/Despliegue/manifestation/components/Manifest SistemaHotel.png[align=center, width=600]
...
image:../images/Despliegue/manifestation/components/Manifest SistemaHuesped.png[align=center, width=600]
...
image:../images/Despliegue/manifestation/components/Manifest SistemaReservacion.png[align=center, width=600]
...
image:../images/Despliegue/manifestation/components/Manifest SistemaEstancia.png[align=center, width=600]

Por úlitmo, está la capa de presentación, la cual será lo que llega al cliente en su navegador web, considero importante mencionar que la carpeta _componentes/_ contiene los componentes de React, no los de nuestro sistema.

El artefacto _routes.jsx_ son las rutas de navegabilidad que tienen nuestras vistas.

image:../images/Despliegue/manifestation/components/Manifest CapaPresentacion.png[align=center, width=600]

=== Diagrama de despliegue

Finalmente tenemos el diagrama de despliegue del sistema, donde se comunica el navegador web (cliente) con la _capa de presentación_ construída en React mediante HTTPS/HTTP con nuestro servidor, el cual es donde se ejecuta la _capa de lógica de negocio_ y la _capa de persistencia_ bajo un ambiente de ejecución de Node.js.
...
Podemos ver claramente representada la arquitectura por capas, bien respetada.
