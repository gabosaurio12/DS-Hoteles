...
*Actores:* Administrador de la cadena (Admin)+
*Descripción:* El _Admin_ registra una nueva habitacion a un hotel +
*Precondiciones:* Debe existir por lo menos 1 hotel en el sistema, debe estarse en la ventana de configuracion de hotel.

*Flujo normal* +
1. El _Admin_ da click en agregar habitaicon (ver FA02)+
2. El _Sistema_ solicita los datos de habitacion +
3. El _Admin_ Ingresa los datos y confirma la habitacion (Ver FA02)(ver FA01) +
...
1. El _Admin_ cancela la accion de crear habitacion +
2. Termina el CU.
