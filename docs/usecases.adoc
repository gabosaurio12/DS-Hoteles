...
3. El _Sistema_ solicita los datos de pago al _Huésped_ (ver FA02) +
...
1. El Sistema recibe del sistema de pagos la notificación de que el pago fue rechazado. +
2. El Sistema informa al Recepcionista que el pago no pudo completarse. +
...
1. El Sistema detecta que la estancia del Huésped no genera cargos pendientes. +
2. El Sistema informa al Recepcionista que no es necesario realizar ningún cobro. +
...
*Actores:* Administrador de la cadena (Admin) +
*Descripción:* El _Admin_ modifica los datos de un hotel. +
*Precondiciones:* Debe haber al menos un hotel registrado.

*Flujo normal* +
1. El _Admin_ selecciona el hotel que desea actualizar. +
2. El _Sistema_ muestra lo datos del hotel seleccionado para actualizarlos (ver EX01). +
3. El _Admin_ actualiza los datos del hotel (ver FA01). +
4. El _Admin_ selecciona "Guardar". +
5. El _Sistema_ actualiza los datos del hotel (ver EX01). +
6. Termina el caso de uso.
...
*Postcondiciones:* Los datos del hotel seleccionado es actualizado. +
*Reglas de negocio:* N/A +
*Incluye:* N/A +
*Extiende:* CU15 +
