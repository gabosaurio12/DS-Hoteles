...
.Casos de uso del Administrador de la cadena
image::images/CU_Administrador de Cadena.png[Use Case Diagram, width=600, align=center]

.Casos de uso del Administrador del hotel
image::images/CU_Administrador del hotel.png[Use Case Diagram, width=600, align=center]

.Casos de uso del Auditor
image::images/CU_Auditor.png[Use Case Diagram, width=600, align=center]
